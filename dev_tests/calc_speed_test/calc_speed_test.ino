 ...
 *  This test checks the speed at which we can do the calcualtions 
 *  
 */
...
void loop() {
  ...
  if(1){  //change back to <central> for the if condition
        ...
        //update data if user has calibrated and pressed the start button
        if(1){   //replace: local_start_flag && local_calib_flag
        ...
        //small 0.1s delay, will be tuned down and eventually removed
      }
      delay(18);
}
